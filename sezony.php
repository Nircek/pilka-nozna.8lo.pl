    ...
    <div id="container">
        ...
        <div id="content-border">
            <?php
                ...
                // ========================================== MENU SEZONÓW =================================
                if(!isset($_GET['s'])){
                    echo "<div id='content' style='background-color: rgba(20, 21, 24, 0.9); width: 960px; padding: 20px;'>";
            ...
            <div id="content">
                <div id="head">
                    ...
                    <?php
                        echo "<span><h1>SEZON $sezon_pelny </h1></span>";
                    ?>
                </div>
                    ...
                    <?php
                        ...
                        if(sprawdzanie_tabela($pdo, $sezon_final)) {
                            ...
                            foreach ($runda_finalowa as $runda_finalowa) {
                                ...
                                if($final[$i][5] == 3) $final[$i][5] = "3 MIEJSCE";
                                elseif($final[$i][5] == 2) $final[$i][5] = "PÓŁFINAŁ";
                                elseif($final[$i][5] == 1) $final[$i][5] = "FINAŁ";

                                if(empty($final[$i][0])) $final[$i][0] = "?";
                                if(empty($final[$i][1])) $final[$i][1] = "?";

                                if($final[$i][4] == "0000-00-00") $final[$i][4]  = "nie ustalono";
