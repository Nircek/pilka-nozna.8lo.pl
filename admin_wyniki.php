        ...
        <div id="content-border">
            <div id="content">
                ...
                if (sprawdzanie_tabela($pdo, $sezon_final)) {
                    ...
                    echo "<form method='post' action='skrypty/wyniki.php'>";
                    $y = 4;
                    foreach ($runda_finalowa as $runda_finalowa) {
                        ...
                        if (empty($final[$y][1]) or empty($final[$y][2])) {
                            ...
                            echo $etap . " | " . $final[$y][1] . " vs " . $final[$y][2] . " <br/>";
                        } else {
                            echo $etap . " | " . $final[$y][1] . "<input class='wynik' type='number' value='" . $final[$y][3] . "' name='f_wynik_1_$y'>
                            ...
                            echo "<input type='hidden' value='" . $final[$y][5] . "' name='f_etap_$y'><br/>";
                        }
                        $y--;
                    }
                    echo "<input type='hidden' name='final'>"; // Zmienna żeby sprawdzić czy wysłano
                ...
                foreach ($termin_1 as $termin_1) {
                    ...
                    $d1 = $termin_1[$i][0];
                    $d2 = $termin_1[$i][0];
                    echo $termin_1[$i][1] . "<input class='wynik' type='number' name='" . $d1 . "_1' value='" . $termin_1[$i][5] . "'>
                ...
                echo "<input type='hidden' value='$i' name='liczba_1'>";

                echo "</div><div id='grupy'>";
                $i = 1;
                foreach ($termin_2 as $termin_2) {
                    ...
                    $d1 = $termin_2[$i][0];
                    $d2 = $termin_2[$i][0];
                    echo $termin_2[$i][1] . "<input class='wynik' type='number' name='" . $d1 . "_1' value='" . $termin_2[$i][5] . "'>
                ...
                echo "</div>";
                echo "<input type='hidden' value='$i' name='liczba_2'>";
