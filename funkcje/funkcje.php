...
//=====================================================================
	...
	function harmonogram_grupy($tabela, $grupa)
	{
		$sezon_terminarz = $tabela;
...
// =========================================================================== //	
	...
	function tabela($wariant, $sezon_tabela, $grupa)
	{
		/* 
		...
		*/
		...
		if($wariant == 1)
		{
			...
			try
			{
				$sql = "SELECT * FROM $sezon_tabela WHERE grupa=$grupa ORDER BY pkt DESC";
